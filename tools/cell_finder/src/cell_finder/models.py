...
class HexGraphConfig:
    ...
    Attributes:
        ...
        comb_mask: np.ndarray | None = None
            Optional binary mask for valid honeycomb region.
            If provided, the graph will only grow and accept cell positions within the mask (mask > 0).
            Used to restrict cell detection and graph growth to the actual comb area, as determined by a segmentation model.
    """
