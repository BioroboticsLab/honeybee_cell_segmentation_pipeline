...
from utils import restrict_brush_layer_tools, show_unlabeled_warning, patch_napari_points_highlight
...
class AnnotationViewer(QObject):
    ...
    def _set_custom_brush_limit(self, max_size: int = 150) -> None:
        ...
        # brush_control = self.viewer.window._qt_viewer.controls.widgets[self.brush_layer]
        # brush_control._brush_size_slider_control.brush_size_slider.setMaximum(max_size)
