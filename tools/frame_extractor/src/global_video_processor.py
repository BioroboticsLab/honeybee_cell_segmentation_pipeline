...
class GlobalVideoProcessor:
    ...
    def __init__(
        ...
        assert self.out_dir.is_dir(), f"output dir {self.out_dir} is no directory"
    ...
    def _collect_video_files(self) -> dict[str, list[tuple[Path, Path]]]:
        ...
        if not day_dirs:
            raise FileNotFoundError(
                "No valid video directories found! Please consult the README to ensure your input directory structure matches the required format."
            )
