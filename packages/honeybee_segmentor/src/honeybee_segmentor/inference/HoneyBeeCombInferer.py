...
from honeybee_segmentor.config import config_default, label_classes_default
from honeybee_segmentor.dataset.CustomDataset import CustomDataset
from honeybee_segmentor.model.HoneyBeeCombSegmentationModel import HoneyBeeCombSegmentationModel
from honeybee_segmentor.utils.utils import (
...
class HoneyBeeCombInferer:
    def __init__(
        ...
        self.model = HoneyBeeCombSegmentationModel(
            model_name=model_name, device=device, path_to_pretrained_models=path_to_pretrained_models, num_classes=num_classes
        )
